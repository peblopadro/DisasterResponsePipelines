...
def evaluate_model(model, X_test, Y_test, category_names):                     
    ...
    """             
    Y_pred = model.best_estimator_.predict(X_test) #model.best_estimator_
...
def main():
    if len(sys.argv) == 3:
        ...
        ### remember: ###
        # models/train_classifier.py is sys.argv[0] --> name of the script
        # data/DisasterResponse.db is sys.argv[1] --> database_filepath
        # models/classifier.pkl is sys.argv[2] --> model_filepath
        
        print('Loading data...\n    DATABASE: {}'.format(database_filepath))
        
        X, Y, category_names = load_data(database_filepath) #df
        ...
        #print(df[['request','aid_related','storm']].head(6) )
        print('\n')
